...
/*
 * AddParentDialog.java
 *
 * Created on Dec 7, 2013, 9:29:02 AM
 */
 ...
 * @author Royal
 */
public class AddParentDialog extends javax.swing.JDialog {
    
    static Student student = null;

    /** Creates new form AddParentDialog */
    public AddParentDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        /*try {
        if (student != null) {
        studentName.setText(student.getFirstName().toUpperCase() + " " + student.getOtherName() + " " + student.getLastName());
        Image img = Toolkit.getDefaultToolkit().createImage(student.getImageData());
        ImageIcon icon = new ImageIcon(((new ImageIcon(img)).getImage()).getScaledInstance(109, 115, java.awt.Image.SCALE_SMOOTH));
    ...
    private void initComponents() {
        ...
        registerParent = new javax.swing.JButton();
        ...
        registerParent.setText("Save");
        registerParent.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        registerParent.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                registerParentActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(375, 375, 375)
                        .addComponent(registerParent, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(38, Short.MAX_VALUE))
        );

        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {contact, firstName, lastName, middleName, occupation, relationship, residence, status});
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(registerParent, javax.swing.GroupLayout.PREFERRED_SIZE, 38, javax.swing.GroupLayout.PREFERRED_SIZE)))
...
private void registerParentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerParentActionPerformed
// TODO add your handling code here:
    try {
        if (firstName.getText().trim().isEmpty()) {
            ...
            boolean parentRegistered = new Controller().registerNewParent(new Parent(
        ...
        if (parentRegistered == true) {
            JOptionPane.showMessageDialog(this, "Parent Registered Successfully");
...
}//GEN-LAST:event_registerParentActionPerformed
...
// TODO add your handling code here:
    if (studentName.getText().length() == 1) {
        try {
            StudentSearchDialog.searchRequestSource="addParent";
            StudentSearchDialog studentSearchDialog = new StudentSearchDialog(VPSSMSClient.mainWindow, true);
            studentSearchDialog.setLocation((int) (VPSSMSClient.width / 10), (int) (VPSSMSClient.height / 10));
            studentSearchDialog.setTitle("Search for Student");
            studentSearchDialog.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddParentDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                AddParentDialog dialog = new AddParentDialog(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JButton registerParent;
